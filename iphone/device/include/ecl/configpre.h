...
#ifdef GBC_BOEHM
#define	ADIMLIM		536870911L	/*  array dimension limit	*/
#define	ATOTLIM		536870911L	/*  array total limit		*/
#else
...
#  define ECL_MATHERR_TEST if (fetestexcept(FE_ALL_EXCEPT)) ecl_deliver_fpe();
# else
